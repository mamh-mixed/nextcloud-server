...
final class RegistryTest extends TestCase {
	...
	public function testRegisterPermissionCategory(): void {
		$permissionCategoryType = new TestSharePermissionCategoryType1();
	...
	public function testRegisterPermission(): void {
		...
		$permissionCategoryType1 = new TestSharePermissionCategoryType1();
		$this->registry->registerPermissionCategoryType($permissionCategoryType1);
		$permissionCategoryType2 = new TestSharePermissionCategoryType2();
		$this->registry->registerPermissionCategoryType($permissionCategoryType2);
