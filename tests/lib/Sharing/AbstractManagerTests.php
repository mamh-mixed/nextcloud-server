...
abstract class AbstractManagerTests extends TestCase {
	...
	public function testSearchRecipients(): void {
		...
		$this->assertEquals([
			['class' => TestShareRecipientType1::class, 'value' => 'recipient1a', 'instance' => null, 'display_name' => 'Recipient 1A', 'icon' => ['svg' => '<svg/>']],
			['class' => TestShareRecipientType1::class, 'value' => 'recipient1b', 'instance' => null, 'display_name' => 'Recipient 1B', 'icon' => ['svg' => '<svg/>']],
			['class' => TestShareRecipientType1::class, 'value' => 'recipient1c', 'instance' => null, 'display_name' => 'Recipient 1C', 'icon' => ['svg' => '<svg/>']],
			['class' => TestShareRecipientType2::class, 'value' => 'recipient2a', 'instance' => null, 'display_name' => 'Recipient 2A', 'icon' => ['svg' => '<svg/>']],
			['class' => TestShareRecipientType2::class, 'value' => 'recipient2b', 'instance' => null, 'display_name' => 'Recipient 2B', 'icon' => ['svg' => '<svg/>']],
			['class' => TestShareRecipientType2::class, 'value' => 'recipient2c', 'instance' => null, 'display_name' => 'Recipient 2C', 'icon' => ['svg' => '<svg/>']],
	...
	public function testSearchRecipientsUniqueDisplayNames(): void {
		...
		$this->assertEquals([
			['class' => TestShareRecipientType1::class, 'value' => 'recipient1', 'instance' => null, 'display_name' => 'Recipient (TestShareRecipientType1: recipient1)', 'icon' => ['svg' => '<svg/>']],
			['class' => TestShareRecipientType2::class, 'value' => 'recipient2', 'instance' => null, 'display_name' => 'Recipient (TestShareRecipientType2: recipient2)', 'icon' => ['svg' => '<svg/>']],
			['class' => TestShareRecipientType2::class, 'value' => 'recipient3', 'instance' => null, 'display_name' => 'Other', 'icon' => ['svg' => '<svg/>']],
		], $this->searchRecipients($accessContext, null, 'recipient', 10, 0));
	}
	...
	public function testSearchRecipientsIcons(): void {
		...
		$this->assertEquals([
			['class' => TestShareRecipientType1::class, 'value' => 'svg', 'instance' => null, 'display_name' => 'SVG', 'icon' => ['svg' => '<svg/>']],
			['class' => TestShareRecipientType1::class, 'value' => 'url', 'instance' => null, 'display_name' => 'URL', 'icon' => ['light' => 'https://example.com/light.png', 'dark' => 'https://example.com/dark.png',]],
		...
		$this->assertEquals([
			...
			'permissions' => [
				[
					...
					'hint' => 'Allow share recipients to share again to others.',
